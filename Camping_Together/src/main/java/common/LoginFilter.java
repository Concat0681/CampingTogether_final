...
public class LoginFilter implements Filter {
	...
	private static final String[] adminList = {"/insertShop*", "/updateShop*", "/shopProductList*", "/allMember*", "/blackMemberList*", "/adminMember*", "/noticeWrite*", "/noticeUpdate*", "/campingWrite*", "/campingUpdate"};
	@Override
